...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    _FyshArray = [[NSMutableArray alloc] initWithArray:[[FMDBManage shareIntance] allFYSH]];
    
    _connArr = [NSMutableArray array];
    
    _remindDict = [NSMutableDictionary dictionary];
    
    _counterDict = [NSMutableDictionary dictionary];
    if (_FyshArray.count != 0) {
        
        if (_FyshArray.count > 1) {
    ...
    self.characteristicsArr = [[NSMutableArray alloc] init];
