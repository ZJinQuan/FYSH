...
- (void)dealloc
{
    ...
    self.destructiveButtonTitleColor = nil;
    self.titleTextColor = nil;
    self.cancelButtonTitleColor = nil;
    self.otherButtonTitlesIndexColor = nil;
}
...
- (instancetype)initWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle destructiveButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSArray *)otherButtonTitles handler:(ALActionSheetViewDidSelectButtonBlock)block;
{
    ...
    if (self)
    {
        ...
        if (_destructiveButtonTitle && _destructiveButtonTitle.length>0)
        {
            ...
            //[UIColor colorWithRed:1 green:79.0f/255.0f blue:0 alpha:1.0f]
            /**
             *  新增颜色选择
             */
            if (_destructiveButtonTitleColor) {
                [destructiveButton setTitleColor:_destructiveButtonTitleColor forState:UIControlStateNormal];
            } else {
